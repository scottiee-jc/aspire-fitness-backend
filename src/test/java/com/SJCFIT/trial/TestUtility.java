...
public class TestUtility {
    ...
    public Workout createMockWorkout(){
        ...
        Exercise bodyweightExercise =
                new BodyweightExercise("Push Ups", PUSH_UP_DESCRIPTION, Intensity.MODERATE.getValue(), 2, 15);
        Exercise weightLiftingExercise =
                new WeightliftingExercise("Squats", SQUAT_DESCRIPTION, Intensity.HIGH.getValue(), 2, 10, new Weight(80, "KG"), new Equipment("Barbell", null));
